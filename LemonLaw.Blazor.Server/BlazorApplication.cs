...
{
    public class LemonLawBlazorApplication : BlazorApplication
    {
        ...
        void LemonLawBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
